...
export type QuickAction = "expense" | "income" | "transfer" | "account";

const actions = [
  { id: "expense", label: "Nuevo gasto", hint: "Registrar una salida", icon: ArrowUpRight },
  { id: "income", label: "Nuevo ingreso", hint: "Registrar una entrada", icon: ArrowDownLeft },
