...
export function Topbar({ identity, onMenu, onQuickAction, onSearch }: { identity: string; onMenu: () => void; onQuickAction: (action: QuickAction) => void; onSearch: () => void }) {
  ...
  return <header className="sticky top-0 z-20 flex h-16 items-center justify-between border-b border-border/70 bg-surface/90 px-4 backdrop-blur-xl sm:px-6 lg:px-8 print:hidden">
