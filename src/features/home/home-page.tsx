  ...
  return <PageTransition><div className="space-y-12">
    ...
    <PageSection title="Necesita tu atención">
      <div className="divide-y divide-border/60 border-y border-border/60">
        ...
        {otherTotals.length ? <Attention icon={<Landmark className="size-5" />} title="Totales separados por moneda" detail="Cada moneda se muestra por separado para que los totales sigan siendo claros." /> : null}
      </div>
    </PageSection>
