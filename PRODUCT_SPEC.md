...
Las Fases 1, 2, 3A, 3B, 4A, 4B, 5A y 5B (salvo exportación) implementan el fundamento técnico, Auth, perfil, monedas, cuentas, movimientos, tarjetas, MSI personales y de terceros/compartidos, y personas con cuentas por cobrar, periodo de cobro consolidado y saldo a favor. Los saldos y métricas consumen proyecciones compartidas; la UI nunca edita un saldo calculado.
...
Continúan como contrato de diseño futuro, sin implementación parcial: estados compartibles en PDF/Excel/CSV, presupuestos, planificación, salud, reportes, conciliación e importaciones bancarias.
